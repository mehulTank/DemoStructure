...
import com.automobile.service.revalAnimation.animation.SupportAnimator;
...
public class SheetLayout extends FrameLayout {
    ...
    private void expandPreLollipop(int x, int y, float startRadius, float endRadius) {
        ...
        SupportAnimator toolbarExpandAnim = com.automobile.service.revalAnimation.animation.ViewAnimationUtils
    ...
    private void contractPreLollipop(int x, int y, float startRadius, float endRadius) {
        ...
        final SupportAnimator toolbarContractAnim = com.automobile.service.revalAnimation.animation.ViewAnimationUtils
